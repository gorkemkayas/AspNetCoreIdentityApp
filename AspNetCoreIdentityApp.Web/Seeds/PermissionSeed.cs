...
namespace AspNetCoreIdentityApp.Web.Seeds
{
    public class PermissionSeed
    {
        ...
        {
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Stock.Read));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Order.Read));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Catalog.Read));
        }
        public static async Task AddUpdatePermission(AppRole role, RoleManager<AppRole> roleManager)
        {
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Stock.Update));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Order.Update));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Catalog.Update));
        }
        public static async Task AddCreatePermission(AppRole role, RoleManager<AppRole> roleManager)
        {
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Stock.Create));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Order.Create));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Catalog.Create));
        }
        public static async Task AddDeletePermission(AppRole role, RoleManager<AppRole> roleManager)
        {
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Stock.Delete));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Order.Delete));
            await roleManager.AddClaimAsync(role, new Claim("Permission", PermissionRoot.Permissions.Catalog.Delete));
        }
